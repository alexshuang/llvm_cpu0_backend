...
extern "C" void LLVMInitializeCpu0TargetInfo() {
    RegisterTarget<Triple::cpu0, /*HasJIT=*/true>(TheCpu0Target, "cpu0",
                                                  "CPU0 (32 bit big endian)", "cpu0");
    RegisterTarget<Triple::cpu0el, /*HasJIT=*/true>(TheCpu0elTarget, "cpu0el",
                                                  "CPU0 (32 bit little endian)", "cpu0el");
}